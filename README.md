...
3. 科学范式的演变
*   **原本（Hypothesis-driven）**：预设假设，遵循**Question-Information-Analysis-Modeling**的顺序。
*   **第 4 范式 (Big Data-driven)**：从海量数据中挖掘关联，不预设假设，即**Information-Analysis-Modeling-Question**。
*   **第 5 范式 (AI-driven)**（预测）：利用**AI**进行多模态、多尺度的建模与生成，加速科学发现。
